...
import org.jdkstack.jdkweb.web.data.ParameterMetaData;

public class RestGetHandler implements HttpHandler {

  private RestServiceModuleLifecycle restServiceModuleLifecycle;

  public RestGetHandler(RestServiceModuleLifecycle restServiceModuleLifecycle) {
    this.restServiceModuleLifecycle = restServiceModuleLifecycle;
  }
    ...
    if ("HTTP/1.1".equals(protocol)) {
      ...
      if (path.contains(".")) {
        ...
        if ("GET".equals(requestMethod)) {
          ...
          MethodMetaData methodMetaData = restServiceModuleLifecycle.fullyPaths.get(path);
          List<ParameterMetaData> parameterMetaDatas = restServiceModuleLifecycle.getFullyPathsParams().get(path);
          ...
          ControllerMetaData controllerMetaData = restServiceModuleLifecycle.getControllerMetaDataMap().get(methodMetaData.getBasePath());
          Object obj;
          ...
          if (obj == null && !singleton) {
            Class<?> aClass = restServiceModuleLifecycle.getFullyQualifiedClasses().get(path);
